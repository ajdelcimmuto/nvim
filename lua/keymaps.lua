...
vim.keymap.set('n', 'ge', vim.diagnostic.open_float, { noremap = true, silent = true, desc = "Show line diagnostics" })
...
vim.keymap.set('n', '<leader>fd', builtin.lsp_definitions, { desc = "Find def" })
...
vim.keymap.set('n', '<leader>fs', builtin.lsp_document_symbols, { desc = "Find doc symbols" })
...
vim.keymap.set('t', '<Esc>', '<C-\\><C-N>', { noremap = true, desc = "Terminal back to normal mode" })
